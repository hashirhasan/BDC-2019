...
<head>
  ...
  body {
    overflow: hidden;
        ...
        <div class="section fact" data-tooltip="Facts">
            ...
            <div class="container">
                <ul class="nav nav-tabs " id="myTab" role="tablist">
                    ...
                    <li class="nav-item borderXwidth">
                        <a class="nav-link hvr-underline-from-left" data-toggle="tab" href="#tathya" role="tab" aria-selected="false">Facts</a>
                    </li>
                    <li class="nav-item borderXwidth">
                        <a class="nav-link hvr-underline-from-left " data-toggle="tab" href="#mythos" role="tab" aria-selected="false">Myths</a>
                    </li>
                </ul>
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="ricmartin" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <span class="tabtext">
                            I first began donating blood when I turned 21 in 1973 with the American Red Cross and I gave about two gallons of whole blood there before I started donating with the local agency, Inova, in'76. 
                            <br>
                            <br>My father was a donor, so I followed in his footsteps. He was a marine before he became a D.C. Police Officer and though we never talked about it I assume between the military and police department he had seen the need while serving his country. 
                            <br>
                            <br> It makes me very proud that my daughter(Ashley)  is now a regular donor; we have been able to bond over the experience. I get to see her every time she donates
                    ...
                    <div class="tab-pane fade" id="socialaware" role="tabpanel" aria-labelledby="profile-tab">
                        ...
                        It becomes exemplary when blood donation comes into spotlight, your little effort could give a gift of life to someone else. 
                        According to a WHO report, out of the needed 12 million units of blood only 9 million units are available. 
                        More than 38, 000 donations are needed per day. Moreover, there are some patients who need blood transfusions on a daily basis. 
                        All these problems can be solved, if you just spare 5 minutes of your life to donate blood.
                        <br>
                        <br>
                        Your 1 pint blood can be a life saviour for that accident victim or that cancer patient. Each drop of blood is of utter value.
                        It's you who is to decide if you want to make a difference.
                            <br>
                            <br> Moreover, blood donation safety will be ensured by AKGEC, itself.
                             All the vials and syringes will be safe to use. Every one will follow a proper code of conduct to ensure your safety.
                        </div>
                    </div>
                    <div class="tab-pane fade" id="tathya" role="tabpanel" aria-labelledby="contact-tab">
                        <h1 class="tabtitle">FACTS</h1>
                        ...
                        <span class="tabtext">
                            ...
                            <br>
                            <br> Donors can give either whole blood or specific blood components only. 
                            <br>
                            <br> One blood donation can save the lives of up to three people.
                            <br>
                            <br> The blood type most often requested by hospitals is type O. 
                            <br>
                            <br> Donating blood is a safe process. A sterile needle is used only once for each donor and then discarded.  
                            <br>
                    ...
                    <div class="tab-pane fade" id="mythos" role="tabpanel" aria-labelledby="contact-tab">
                        <h1 class="tabtitle">MYTHS</h1>
                        <img src="assets/bloodbag1.png" class="img-fluid tab-img" data-tilt data-tilt-reset="false">
                        <span class="tabtext">
                            Giving blood hurts and in time consuming.
                            <br>
                            <br> There is limited blood in the body and it is unhealthy to give some away. 
                            <br>
                            <br> Blood donation isn't for women. 
                            <br>
                            <br> Health deteriorates after donating blood. 
                            <br>
                            <br> If you smoke, you cannot be a blood donor.
                            <br>
                            <br> A blood donor is prone to infection. 
                        </span>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid ">
        ...
        <div class="row justify-content-center no-gutter">
            ...
            <div class="col-md-2 col-sm-5 col-5 team-member" >
                ...
                <span class="member-name">Convenor</span>
            </div>
            <div class="col-md-2 col-sm-5 col-5 team-member">
